...
public class CreateArrays {
	 ...
	 */
		...
		int k = 2;
		int offset = 7;		//How far to move along the array in each iteration. Moving 7 to avoid the possibility of elements getting moved more than 4 spaces from where they should be.
		int[] partialSorted = createRandomArray(n);
		Arrays.sort(partialSorted);
